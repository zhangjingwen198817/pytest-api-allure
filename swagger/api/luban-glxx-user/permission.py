...
class Permission:
    ...
    def saveRoleMenuUsingPOST(self, item_fixture, roleId=None, perm=None, moduleType=None):
        '''
        角色和权限绑定接口(新的)
    ...
    def findLikeRoleUsingGET(self, item_fixture, rolename=None, page_size=None, page_index=None):
        '''
        模糊查询角色列表接口带分页
        :param item_fixture: item fixture,
