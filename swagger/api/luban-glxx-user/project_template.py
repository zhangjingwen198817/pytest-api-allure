...
class Project_template:
    ...
    def bindDataTemplate2ProjectTemplateUsingPOST(self, item_fixture, type=None, dataTemplateItemId=None, projectTemplateId=None):
        '''
        工程模板和资料模板条目绑定接口
    ...
    def pageProjectTemplateUsingGET(self, item_fixture, pageIndex=None, pageSize=50):
        '''
        查询工程模板接口(分页)
        :param item_fixture: item fixture,
    ...
    def saveProjectTemplateUsingPOST(self, item_fixture, parentId=None, nameList=None):
        '''
        添加工程模板接口
        :param item_fixture: item fixture,
        :param nameList: 工程名称
    ...
    def unBindDataTemplate2ProjectTemplateUsingDELETE(self, item_fixture, type=None, dataTemplateItemId=None, projectTemplateId=None):
        '''
        工程模板和资料模板条目取消绑定接口
        :param item_fixture: item fixture,
        :param dataTemplateItemId: 资料模板条目id
