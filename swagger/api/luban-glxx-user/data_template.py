...
class Data_template:
    ...
    def pageDataTemplateItemUsingGET(self, item_fixture, page_size=None, type=None, page_index=None, templateCode=None, filterNoFormTemplate=None):
        '''
        资料模版条目列表接口（分页）
    ...
    def updateDataTemplateItem2FormTemplateUsingPOST(self, item_fixture, itemId=None, formTemplateId=None):
        '''
        更新资料模版条目关联表单模版接口
        :param item_fixture: item fixture,
    ...
    def updateDataTemplateItem2ProcessTemplateUsingPOST(self, item_fixture, itemId=None, processTemplateId=None, templateCode=None):
        '''
        更新资料模版条目关联流程模版接口
        :param item_fixture: item fixture,
    ...
    def updateDataTemplateItemRelUsingPOST(self, item_fixture, toFormTemplateIds=None, fromFormTemplateId=None):
        '''
        更新资料模版条目关联接口
        :param item_fixture: item fixture,
    ...
    def pageDataTemplateUsingGET(self, item_fixture, pageIndex=None, pageSize=50):
        '''
        资料模板库列表接口（分页）
        :param item_fixture: item fixture,
